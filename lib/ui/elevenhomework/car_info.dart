class Cars {
  static const String app_name = "Rent Car";
  ...
  static const List<String> CAR_INFO = [
    ...
    "Car info",
    "Car info",
    "Mercedes-Benz AG ie global business of Mercedes-Benz Cars and Mercedes-Benz Vans, of the Board of Management of Mercedes-Benz AG. The company focuses on the development, production and sales of passenger cars, vans and vehicle-related services. Furthermore, the company aspires to be thelds of electric mobility and vehicle software. The product portfolio comprises the Mercedes- ",
    "Car info",
    "Car info",
    "Car info",
    "Car info",
